...
class AeWooAddToCart extends Widget_Base {
	...
	protected function ae_woo_simple_add_to_cart( $product ) {
		...
		$this->add_render_attribute( 'woo-add-to-cart-btn-class', 'class', 'button alt' );
		if($settings['enable_ajax_add_to_cart'] == 'yes'){
			$this->add_render_attribute( 'woo-add-to-cart-btn-class', 'class', 'ajax_add_to_cart' );
		}
