...
$(function () {
  ...
  function setThemeMode(themeColor) {
    if (themeColor === lightTheme_class) {
      pageBody.removeClass(lightTheme_class);
      modeSwitcher.addClass(lightTheme_class);
      localStorage.setItem(themeStoredKey, lightTheme_class);

      // Set text and background colors to default for all relevant elements
      testicontent.style.color = "#222";
      testicontentname.style.color = "#222";
      testicontentwork.style.color = "#222";

      testicontent1.style.color = "#222";
      testicontentname1.style.color = "#222";
      testicontentwork1.style.color = "#222";

      testicontent2.style.color = "#222";
      testicontentname2.style.color = "#222";
      testicontentwork2.style.color = "#222";

      testicontent3.style.color = "#222";
      testicontentname3.style.color = "#222";
      testicontentwork3.style.color = "#222";
    }
  }
...
const hireUsButton = document.querySelector('.cta-link-primary');
const whatsappicon = document.querySelector('.fa-whatsapp');
// Add a click event listener to the button
hireUsButton.addEventListener('click', () => {
    const phoneNumber = '+9779827691222';
    const staticMessage = "Welcome To Artova Hire Services";
